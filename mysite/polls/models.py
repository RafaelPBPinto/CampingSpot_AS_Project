...
class Parque(models.Model):
    ...
    parque_rating = models.IntegerField(default=0)

class User(models.Model):
    user_name = models.CharField('username')
    user_history = models ## acabar

class Reserva(models.Model):
    reserva_user = models.ForeignKey(User)
    reserva_price = models.IntegerField(default=0)
